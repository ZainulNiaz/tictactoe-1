...
class _SecondScreenState extends State<SecondScreen> {
  ...
  //checking if user can win in next move
    ...
    if(click1==100){array.add(n);}
    n++;
    if(click2==100){array.add(n);}
    n++;
    if(click3==100){array.add(n);}
    n++;
    if(click4==100){array.add(n);}
    n++;
    if(click5==100){array.add(n);}
    n++;
    if(click6==100){array.add(n);}
    n++;
    if(click7==100){array.add(n);}
    n++;
    if(click8==100){array.add(n);}
    n++;
    if(click9==100){array.add(n);}
    int g = array.length;
